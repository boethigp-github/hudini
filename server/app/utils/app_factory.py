...
from server.app.routes.swagger import register_swagger_blueprints
from server.app.routes.models import models_blueprint
from server.app.routes.prompts import prompts_blueprint
from server.app.routes.generations import generations_blueprint
